...
function parseDateInfo(timestamp?: TimeStamp) {
...
function formatDate(inputDate: Date, formatString: string) {
  return formatString
...
function formatDateToReadableString(inputDate: Date | string | number | undefined) {
  return formatDate(
    inputDate
