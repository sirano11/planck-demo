...
export default function PortfolioPageThumbnailIcon(
  props: SvgIcon & { isActive?: boolean; colorMode?: ColorMode },
) {
  const {
    colorMode,
    isActive,
    color = isActive && colorMode === 'light'
      ? colors.secondary
  ...
  return isActive ? (
    ...
    >
      <circle
        opacity={colorMode === 'light' ? '0.4' : '0.8'}
        cx="11"
        cy="11"
        r="4"
        stroke="none"
