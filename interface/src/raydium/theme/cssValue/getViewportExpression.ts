 ...
 */
function getViewportExpression(option: { direction: 'w' | 'h'; p1: CSSLengthPoint; p2: CSSLengthPoint; clamp?: boolean }) {
...
/** clamp is alway true */
function getVWExpression(p1: CSSLengthPoint, p2: CSSLengthPoint) {
