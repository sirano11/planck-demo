...
const revertAppLayoutPaddingX = ['-20px', `min((100vw - ${contentWidth}) / -2, -7%)`]
 ...
 * CSS value
 */
function genCSS3GridTemplateColumns(options: { /** px */ rightLeft?: number | 'auto'; /** px */ center: number }) {
 ...
 * CSS value
 */
function genCSS2GridTemplateColumns(options: { /** px */ rightLeft?: number | 'auto'; /** px */ center: number }) {
