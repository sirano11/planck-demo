...
import RaydiumLogo from '@/raydium/icons/RaydiumLogo';
import RaydiumLogoOutline from '@/raydium/icons/RaydiumLogoOutline';
import ChevronDownIcon from '@/raydium/icons/misc/ChevronDownIcon';
import Gear from '@/raydium/icons/misc/Gear';
// import { useAppStore } from '@/raydium/store';
import { colors } from '@/raydium/theme/cssVariables';
import { appLayoutPaddingX } from '@/raydium/theme/detailConfig';
import { toUTC } from '@/raydium/utils/date';
        ...
        <Desktop>
          ...
          >
            ...
            <RouteLink
              ...
              isActive={pathname.includes('/liquidity')}
            >
              {t('liquidity.title')}
            </RouteLink>
      ...
      pc={
        <Link href={props.href}>
          <Text
            as="span"
            textColor={
              props.isActive ? colors.textSecondary : colors.textTertiary
            }
            fontSize="lg"
            px={4}
            py={2}
...
function SettingsMenuModalContent(props: {
  isOpen: boolean;
  ...
  const getTriggerRect = () =>
    props.triggerRef.current?.getBoundingClientRect();
